...
图片必须体现三元组中的 `event_type`，通过视觉元素传达事件性质：

| 核心事件 | 视觉元素建议 |
|----------|-------------|
| 绝杀进球 | 球员剪影、球网震颤、金色光芒、胜利姿态 |
| 点球大战失利 | 孤独背影、空旷球门、雨滴、黯淡灯光 |
| 帽子戏法 | 三颗足球、庆祝动作、聚光灯、金色数字"3" |
| 红牌退场 | 红色卡片、离场背影、沉默、灰色调 |
| 夺冠时刻 | 举起奖杯、金色雨、欢腾人群、国旗飘扬 |
| 告别演出 | 挥手告别、夕阳、模糊背影、怀旧色调 |
